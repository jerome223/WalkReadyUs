    ...
    constructor(credentials, parameters) {
        ...
        this.timeFilterFast = (request) => __awaiter(this, void 0, void 0, function* () {
            return this.readProtoFile()
                .then((root) => __awaiter(this, void 0, void 0, function* () { return this.handleProtoFile(root, this.baseURL, request); }));
        });
        this.timeFilterFastDistance = (request) => __awaiter(this, void 0, void 0, function* () {
            return this.readProtoFile()
                .then((root) => __awaiter(this, void 0, void 0, function* () { return this.handleProtoFile(root, this.baseURL, request, { useDistance: true }); }));
        });
        ...
        this.applicationId = credentials.applicationId;
        this.apiKey = credentials.apiKey;
        this.baseURL = (parameters === null || parameters === void 0 ? void 0 : parameters.baseUrl) || DEFAULT_BASE_URL;
