...
export declare type TransportationTypeNoPt = 'walking' | 'cycling' | 'driving' | 'ferry' | 'cycling+ferry' | 'driving+ferry';
...
export declare type TransportationNoPtRequestCommons = {
...
export declare type BatchResponse<T> = BatchErrorResponse | BatchSuccessResponse<T>;
...
export declare type PolygonsFilter = {
    limit: number;
};
