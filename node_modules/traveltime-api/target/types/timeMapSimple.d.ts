import { RangeRequestNoMaxResults, LevelOfDetail, Coords, TransportationRequestCommons, TransportationFast, PolygonsFilter } from './common';
import { TimeMapRequestProperty } from './timeMap';
export declare type TimeMapSimple = {
    coords: Array<Coords>;
...
export declare type TimeMapFastSimple = {
    coords: Array<Coords>;
