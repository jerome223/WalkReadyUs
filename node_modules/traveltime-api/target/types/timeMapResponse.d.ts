import { TimeMapResponse, TimeMapResponseGeoJSON, TimeMapResponseVndBoundingBoxes, TimeMapResponseVndWkt } from './timeMap';
export declare type TimeMapResponseType = {
...
export declare type TimeMapFastResponseType = Omit<TimeMapResponseType, 'application/kml+xml' | 'application/vnd.google-earth.kml+xml'>;
